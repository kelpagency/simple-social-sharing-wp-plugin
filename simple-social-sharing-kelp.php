...
Plugin URI: https://www.kelp.agency/simple-social-sharing
Description: A social sharing plugin that doesn't suck!
Version: 0.2
Author: Kelp Creative Agency
Author URI: https://www.kelp.agency
License: GPL2
*/
...
class simple_social_sharing_kelp_widget extends WP_Widget
{
  ...
  public function update($new_instance, $old_instance)
  {
    ...
    $instance["design_style"] = isset($new_instance["design_style"])
      ? wp_strip_all_tags($new_instance["design_style"])
      : "";
    $instance["background_color"] = isset($new_instance["background_color"])
      ? wp_strip_all_tags($new_instance["background_color"])
      : "";
    $instance["icon_color"] = isset($new_instance["icon_color"])
      ? wp_strip_all_tags($new_instance["icon_color"])
      : "";
    $instance["layout"] = isset($new_instance["layout"])
      ? wp_strip_all_tags($new_instance["layout"])
      : "";
  ...
  public function widget($args, $instance)
  {
    ...
    $design_style = isset($instance["design_style"])
      ? $instance["design_style"]
      : "";
    ...
    // Display the widget
    echo '<div class="simple-social-sharing ' .
      $design_style .
      " " .
      $layout .
      '">';
